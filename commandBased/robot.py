...
class ExampleBot(CommandBasedRobot):
    ...
    def robotInit(self):
        ...
        """
        # self.FrontLeft = drivetrain.frontLeftCIM
        # self.FrontRight = drivetrain.frontRightCIM
        # self.RearLeft = drivetrain.backLeftCIM
        # self.RearRight = drivetrain.backRightCIM
